...
const heroImage =
    "https://images.unsplash.com/photo-1631545806609-8c5f5f9b7a4a?auto=format&fit=crop&w=2400&q=90";

const industrialImage =
    "https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&w=1800&q=90";

const hvacImage =
    "https://images.unsplash.com/photo-1631545806609-8c5f5f9b7a4a?auto=format&fit=crop&w=1800&q=90";
...
const equipment = [
    {
        ...
        text: "Maintenance and repair support for installed air-conditioning and climate-control systems.",
    },
    {
        number: "02",
        title: "HVAC Equipment",
        text: "Inspection and maintenance support for HVAC equipment and associated systems.",
    },
    {
        number: "03",
        title: "Air Distribution",
        text: "Support for inspection and maintenance of systems responsible for conditioned-air distribution.",
    },
    {
        number: "04",
        title: "Control Systems",
        text: "Technical support and troubleshooting around HVAC system operation and controls.",
    },
];
    ...
    return (
      ...
      ========================================================= */}
            <section className="relative min-h-[82vh] overflow-hidden bg-[#061425]">
                <img
                    src={heroImage}
                    alt="HVAC engineering and climate control system"
                    ...
                    <div className="max-w-5xl">
                        ...
                        <div className="mt-8 max-w-2xl border-l-2 border-[#ffbd00] pl-6">
                            <p className="text-lg leading-8 text-white/75 sm:text-xl">
                                Installation, preventive maintenance, inspection, repair and
                                technical support for HVAC systems and equipment.
                            </p>
                        </div>
                    ...
                    <div className="absolute bottom-8 right-8 hidden lg:block">
                        <div className="border border-white/20 bg-[#061425]/75 p-5 backdrop-blur-md">
                            ...
                            <p className="max-w-[190px] text-sm leading-6 text-white/70">
                                Maintenance support focused on system condition, performance
                    ...
                    <div className="grid gap-16 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
                        <div>
                            ...
                            <p className="mt-7 max-w-xl text-base leading-8 text-slate-600">
                                DeltaCare provides HVAC installation, maintenance and repair
                                support, combining preventive maintenance, system inspection,
                        ...
                        <div className="relative">
                            ...
                            <div className="relative h-[520px] overflow-hidden">
                                <img
                                    src={industrialImage}
                                    alt="HVAC engineering maintenance"
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-8">
                                    ...
                                    <p className="max-w-lg text-2xl font-bold leading-tight text-white">
                                        HVAC maintenance designed around system condition,
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-10">
                    <div className="mb-14 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
                        ...
                        <p className="max-w-md text-sm leading-7 text-slate-500">
                            HVAC service requirements vary by installation and equipment.
                            DeltaCare provides maintenance and technical support around the
                            installed system.
                        </p>
                    </div>
                    ...
                    <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
                        {equipment.map((item) => (
                            <div
                                key={item.number}
                                className="group relative min-h-[300px] overflow-hidden bg-[#071a2e] p-7 transition duration-300 hover:-translate-y-1"
                            >
                    ...
                    <div className="grid gap-16 lg:grid-cols-[0.7fr_1.3fr]">
                        <div>
                            ...
                            <h2 className="text-4xl font-black leading-tight tracking-[-0.03em] text-[#071a2e] sm:text-5xl">
                                ...
                                maintenance to
                                <br />
                                <span className="text-[#0878df]">system repair.</span>
                            </h2>

                            <p className="mt-7 max-w-md text-base leading-8 text-slate-600">
                                HVAC systems depend on regular inspection and maintenance.
                                DeltaCare supports both planned maintenance activities and
                                corrective requirements when system issues arise.
                            </p>
                ...
                <div className="relative mx-auto max-w-7xl px-6 lg:px-10">
                    <div className="grid gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
                        <div className="relative min-h-[530px] overflow-hidden">
                            <img
                                src={hvacImage}
                                alt="HVAC system diagnostics and maintenance"
                                className="absolute inset-0 h-full w-full object-cover"
                            />
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-8">
                                <p className="text-4xl font-black leading-tight text-white">
                                    ...
                                    working before
                                    <br />
                                    <span className="text-[#ffbd00]">comfort is affected.</span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-7 max-w-xl text-base leading-8 text-white/55">
                                A structured maintenance approach helps identify system
                                conditions, address faults and support reliable HVAC operation.
                            </p>
                            ...
                            <div className="mt-9 flex items-start gap-4 border-l-2 border-[#0878df] bg-white/[0.04] p-5">
                                ...
                                <p className="text-sm leading-6 text-white/55">
                                    HVAC maintenance requirements vary by equipment and
                                    installation. Service activities should follow the applicable
                    ...
                    <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
                        <div>
                            ...
                            <h2 className="max-w-4xl text-4xl font-black leading-[1.02] tracking-[-0.04em] text-[#071a2e] sm:text-5xl lg:text-6xl">
                                Need HVAC maintenance, repair or technical support?
                            </h2>
                        </div>
