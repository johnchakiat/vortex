...
const heroImage =
    "https://images.unsplash.com/photo-1621905252507-b35492cc74b4?auto=format&fit=crop&w=2400&q=90";
...
const equipment = [
    {
        number: "01",
        title: "ACBs",
        text: "Maintenance and inspection support for air circuit breakers and associated switchgear equipment.",
    },
    {
        number: "02",
        title: "VFDs",
        text: "Maintenance support for variable frequency drives used within electrical systems.",
    },
    {
        number: "03",
        title: "Capacitor Banks",
        text: "Inspection and maintenance support for capacitor bank installations.",
    },
    {
        number: "04",
        title: "Contactors",
        text: "Inspection, maintenance and replacement support for electrical contactors.",
    },
];
...
export default function SwitchgearMaintenancePage() {
    return (
      ...
      ========================================================= */}
            <section className="relative min-h-[82vh] overflow-hidden bg-[#061425]">
                <img
                    src={heroImage}
                    alt="Electrical switchgear and power distribution equipment"
                    ...
                    <div className="max-w-5xl">
                        ...
                        <div className="mt-8 max-w-2xl border-l-2 border-[#ffbd00] pl-6">
                            <p className="text-lg leading-8 text-white/75 sm:text-xl">
                                Inspection, maintenance, repair, upgrades and technical
                                support for electrical switchgear and associated equipment.
                            </p>
                        </div>
                    ...
                    <div className="absolute bottom-8 right-8 hidden lg:block">
                        <div className="border border-white/20 bg-[#061425]/75 p-5 backdrop-blur-md">
                            ...
                            <p className="max-w-[190px] text-sm leading-6 text-white/70">
                                Maintenance support for critical electrical switching and
                                control equipment.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid gap-16 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
                        <div>
                            ...
                            <h2 className="text-4xl font-black leading-tight tracking-[-0.03em] text-[#071a2e] sm:text-5xl">
                                ...
                                switching systems
                                <br />
                                <span className="text-[#0878df]">ready for operation.</span>
                            </h2>

                            <p className="mt-7 max-w-xl text-base leading-8 text-slate-600">
                                DeltaCare provides maintenance support for electrical switchgear
                                systems, helping identify equipment issues, maintain components,
                                support repairs and keep critical electrical systems operating
                                reliably.
                            </p>
                            ...
                            <div className="relative h-[520px] overflow-hidden">
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-8">
                                    ...
                                    <p className="max-w-lg text-2xl font-bold leading-tight text-white">
                                        Maintenance support for switchgear, control equipment and
                                        electrical panels.
                                    </p>
                                </div>
                            </div>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-10">
                    <div className="mb-14 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
                        ...
                        <p className="max-w-md text-sm leading-7 text-slate-500">
                            Maintenance activities can be tailored around the installed
                            equipment, its condition and the operational requirements of the
                            electrical system.
                        </p>
                    </div>
                    ...
                    <div className="grid gap-16 lg:grid-cols-[0.7fr_1.3fr]">
                        <div>
                            ...
                            <h2 className="text-4xl font-black leading-tight tracking-[-0.03em] text-[#071a2e] sm:text-5xl">
                                ...
                                goes beyond
                                <br />
                                <span className="text-[#0878df]">the panel.</span>
                            </h2>

                            <p className="mt-7 max-w-md text-base leading-8 text-slate-600">
                                From routine inspection to repair, replacement, upgrades and
                                troubleshooting, DeltaCare supports the wider switchgear
                                system rather than focusing on a single component.
                            </p>
                ...
                <div className="relative mx-auto max-w-7xl px-6 lg:px-10">
                    <div className="grid gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
                        <div className="relative min-h-[530px] overflow-hidden">
                            <img
                                src={electricalImage}
                                alt="Electrical switchgear diagnostics"
                                className="absolute inset-0 h-full w-full object-cover"
                            />
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-8">
                                <p className="text-4xl font-black leading-tight text-white">
                                    ...
                                    before it becomes
                                    <br />
                                    <span className="text-[#ffbd00]">a failure.</span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-7 max-w-xl text-base leading-8 text-white/55">
                                Inspection, troubleshooting and thermal imaging can help
                                identify equipment conditions and potential issues within
                            ...
                            <div className="mt-9 flex items-start gap-4 border-l-2 border-[#0878df] bg-white/[0.04] p-5">
                                ...
                                <p className="text-sm leading-6 text-white/55">
                                    Testing and inspection activities should be performed using
                                    appropriate isolation, safety procedures and equipment
                                    requirements.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
                        <div>
                            ...
                            <h2 className="max-w-4xl text-4xl font-black leading-[1.02] tracking-[-0.04em] text-[#071a2e] sm:text-5xl lg:text-6xl">
                                Need maintenance or technical support for your switchgear
                                systems?
                            </h2>
                        </div>
