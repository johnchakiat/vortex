...
const serviceImages = [
    {
        ...
        title: "Transformer Infrastructure",
    },
    {
...
const serviceAreas = [
    {
        number: "01",
        title: "Inspection",
        text: "Inspection and condition assessment to help identify potential equipment issues and maintenance requirements.",
    },
    {
        number: "02",
        title: "Maintenance",
        text: "Planned maintenance support designed around transformer condition and operational requirements.",
    },
    {
        number: "03",
        title: "Repair",
        text: "Technical support for transformer-related repair requirements and corrective maintenance.",
    },
    {
        number: "04",
        title: "Testing",
        text: "Testing and diagnostic support for electrical equipment and transformer-related systems.",
    },
];
                    ...
                    <div className="max-w-5xl">
                        ...
                        <div className="mt-8 max-w-2xl border-l-2 border-[#ffbd00] pl-6">
                            <p className="text-lg leading-8 text-white/75 sm:text-xl">
                                Maintenance, inspection, repair, testing and technical support
                                for transformer and electrical power distribution systems.
                            </p>
                        </div>
                    ...
                    <div className="absolute bottom-8 right-8 hidden lg:block">
                        <div className="border border-white/20 bg-[#061425]/75 p-5 backdrop-blur-md">
                            ...
                            <p className="max-w-[190px] text-sm leading-6 text-white/70">
                                Maintenance support for critical transformer and electrical
                    ...
                    <div className="grid gap-16 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
                        <div>
                            ...
                            <h2 className="text-4xl font-black leading-tight tracking-[-0.03em] text-[#071a2e] sm:text-5xl">
                                ...
                                equipment behind
                                <br />
                                <span className="text-[#0878df]">power distribution.</span>
                            </h2>

                            <p className="mt-7 max-w-xl text-base leading-8 text-slate-600">
                                DeltaCare provides transformer maintenance support covering
                                inspection, maintenance, repair, testing and technical
                                assistance for electrical power distribution systems.
                            </p>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative h-[520px] overflow-hidden">
                                <img
                                    ...
                                    alt="Electrical power equipment"
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-8">
                                    ...
                                    <p className="max-w-lg text-2xl font-bold leading-tight text-white">
                                        Practical maintenance support for transformer systems and
                    ...
                    <div className="mb-14 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
                        <div>
                            ...
                            <h2 className="max-w-3xl text-4xl font-black tracking-[-0.03em] text-[#071a2e] sm:text-5xl">
                                ...
                                <br />
                                cycle for critical equipment.
                            </h2>
                        </div>

                        <p className="max-w-md text-sm leading-7 text-slate-500">
                            Maintenance activities can be structured around equipment
                            condition, inspection findings and operational requirements.
                        </p>
                    </div>
                    ...
                    <div className="grid gap-16 lg:grid-cols-[0.7fr_1.3fr]">
                        <div>
                            ...
                            <h2 className="text-4xl font-black leading-tight tracking-[-0.03em] text-[#071a2e] sm:text-5xl">
                                ...
                                around the
                                <br />
                                <span className="text-[#0878df]">transformer.</span>
                            </h2>

                            <p className="mt-7 max-w-md text-base leading-8 text-slate-600">
                                DeltaCare's service approach covers inspection, maintenance,
                                repair, testing and technical support, helping address
                                transformer maintenance requirements throughout the equipment
                                lifecycle.
                            </p>
                ...
                <div className="relative mx-auto max-w-7xl px-6 lg:px-10">
                    <div className="grid gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
                        <div className="relative min-h-[530px] overflow-hidden">
                            <img
                                src={industrialImage}
                                alt="Electrical equipment inspection"
                                className="absolute inset-0 h-full w-full object-cover"
                            />
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-8">
                                <p className="text-4xl font-black leading-tight text-white">
                                    ...
                                    Understand the
                                    <br />
                                    <span className="text-[#ffbd00]">condition.</span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-7 max-w-xl text-base leading-8 text-white/55">
                                Inspection and diagnostic activities can help identify
                                equipment conditions, support troubleshooting and determine
                            ...
                            <div className="mt-9 flex items-start gap-4 border-l-2 border-[#0878df] bg-white/[0.04] p-5">
                                ...
                                <p className="text-sm leading-6 text-white/55">
                                    Testing and inspection activities should follow the
                                    applicable equipment requirements, site procedures and
                    ...
                    <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
                        <div>
                            ...
                            <h2 className="max-w-4xl text-4xl font-black leading-[1.02] tracking-[-0.04em] text-[#071a2e] sm:text-5xl lg:text-6xl">
                                Need transformer maintenance, inspection or technical support?
                            </h2>
                        </div>
